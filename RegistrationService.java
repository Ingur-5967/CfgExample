...
public class RegistrationService {
    ...
    public void initConfigs(DirectorySource directoryType, String ...files) {
        ...
        Messages.logger("FILES", ">> Files loaded: " + files.length);
    }
    ...
    public void registrationCmd(CommandExecutor[] executors, TabCompleter[] completes, String ...commands) {
        ...
        Messages.logger("COMMANDS-INIT",">> Registered commands: " + commands.length, ">> Success set tab-completer for commands (" + executors.length + " commands)");
    }
